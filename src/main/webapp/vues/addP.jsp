...
<span class="text-danger"> <form:errors path="produit.nom"/></span>
</div>

<div>
<label class="form-label">Price</label>
<input type=number name=prix required class="form-control car">
<span class="text-danger"> <form:errors path="produit.prix"/></span>
</div>

<div>
<label class="form-label">Quantity</label>
<input name=quantite type=number required="required" class="form-control car"><br>
<span class="text-danger"> <form:errors path="produit.quantite"/></span>
</div>
